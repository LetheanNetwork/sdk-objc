...
extern NSString * LTNPercentEscapedStringFromString(NSString *string);

extern NSString * const kLTNApplicationJSONType;

@protocol LTNSanitizer <NSObject>
...
@interface LTNSanitizer : NSObject <LTNSanitizer>
