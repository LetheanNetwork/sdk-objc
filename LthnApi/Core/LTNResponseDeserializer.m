#import "LTNResponseDeserializer.h"
#import <JSONModel/JSONModel.h>
#import <ISO8601/ISO8601.h>

NSString *const LTNDeserializationErrorDomainKey = @"LTNDeserializationErrorDomainKey";

NSInteger const LTNTypeMismatchErrorCode = 143553;

NSInteger const LTNEmptyValueOccurredErrorCode = 143509;

NSInteger const LTNUnknownResponseObjectErrorCode = 143528;


@interface LTNResponseDeserializer ()
...
@implementation LTNResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:LTNDeserializationErrorDomainKey code:LTNTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:LTNDeserializationErrorDomainKey code:LTNEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:LTNDeserializationErrorDomainKey code:LTNUnknownResponseObjectErrorCode userInfo:userInfo];
}
