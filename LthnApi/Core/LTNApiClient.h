 ...
 */
extern NSString *const LTNResponseObjectErrorKey;


@interface LTNApiClient : AFHTTPSessionManager

@property (nonatomic, strong, readonly) id<LTNConfiguration> configuration;

@property(nonatomic, assign) NSTimeInterval timeoutInterval;

@property(nonatomic, strong) id<LTNResponseDeserializer> responseDeserializer;

@property(nonatomic, strong) id<LTNSanitizer> sanitizer;
