 ...
 */
extern NSString *const LTNDeserializationErrorDomainKey;

/**
 * Code for deserialization type mismatch error
 */
extern NSInteger const LTNTypeMismatchErrorCode;

/**
 * Code for deserialization empty value error
 */
extern NSInteger const LTNEmptyValueOccurredErrorCode;

/**
 * Error code for unknown response
 */
extern NSInteger const LTNUnknownResponseObjectErrorCode;

@protocol LTNResponseDeserializer <NSObject>
...
@interface LTNResponseDeserializer : NSObject <LTNResponseDeserializer>
