...
#import "LTNBasicAuthTokenProvider.h"
#import "LTNLogger.h"

@interface LTNDefaultConfiguration ()
...
@implementation LTNDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static LTNDefaultConfiguration *shardConfig = nil;
...
- (instancetype) init {
    ...
    if (self) {
        ...
        _logger = [LTNLogger sharedLogger];
    }
    return self;
}
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [LTNBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
